...
summary=JBake and Gradle are both amazing tools that let you create a static site in no time. I describe how I created this blog that way.
...
I am hinting at Gradle here. Gradle is best for automating any workflow you can imagine. Step by step, let's take a look how to use Gradle and JBake to create a blog. 
